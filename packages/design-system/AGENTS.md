...
```bash
npm run dev          # tsup src/index.ts --format esm,cjs --dts --watch --external react
npm run build        # tsup src/index.ts --format esm,cjs --dts --external react
