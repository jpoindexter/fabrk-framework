/**
 * Default Cloudflare Worker entry point for fabrk App Router.
 *
 * Use this directly in wrangler.jsonc:
 *   "main": "fabrk/server/app-router-entry"
 *
...
// @ts-expect-error — virtual module resolved by fabrk
import rscHandler from "virtual:fabrk-rsc-entry";
