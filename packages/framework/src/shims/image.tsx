 ...
 * For local images (relative paths), routes through `/_fabrk/image`
...
/**
 * Build a `/_fabrk/image` optimization URL.
 *
 ...
 *
 * Each width points to the `/_fabrk/image` optimization endpoint so the
...
const Image = forwardRef<HTMLImageElement, ImageProps>(function Image(
  ...
  // Route local images through the /_fabrk/image optimization endpoint.
  ...
  // Each entry points to /_fabrk/image with the appropriate width.
  ...
  // The src and srcSet point to the /_fabrk/image optimization endpoint.
  return (
    <img
      ref={ref}
      src={optimizedSrc}
...
export function getImageProps(props: ImageProps): {
  ...
  // Build srcSet for local images — each width points to /_fabrk/image
